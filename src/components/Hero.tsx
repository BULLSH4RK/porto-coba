...
export function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center px-6 pt-24 pb-16">
      ...
      >
        <div className="absolute top-6 right-6 md:top-8 md:right-8 opacity-15 pointer-events-none font-mono text-[10px] md:text-xs text-mint leading-relaxed">
          <pre>{profile.codeSnippet}</pre>
        </div>
